  ...
  if (kIsWeb) {
    ...
    await Firebase.initializeApp(
      options: FirebaseOptions(
        apiKey: "AIzaSyAX_at3jEsUDoiO4_KvKfznB4d5_ugYxP8",
        authDomain: "todoapp-ff3fd.firebaseapp.com",
        projectId: "todoapp-ff3fd",
        storageBucket: "todoapp-ff3fd.appspot.com",
        messagingSenderId: "96945697501",
        appId: "1:96945697501:web:c7c6553f715b0ac7aa2134",
...
class _TodoScreenState extends State<TodoScreen> {
  ...
  final TextEditingController _detailController =
      TextEditingController(); // Controller for task details
              ...
              Expanded(
                child: StreamBuilder(
                  ...
                  builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                    ...
                    List<QueryDocumentSnapshot> sortedTasks =
                        snapshot.data!.docs;
                            ...
                            return MapEntry(
                              ...
                              ListTile(
                                ...
                                tileColor: isCompleted
                                    ? Colors.grey[300]
                                    : backgroundColor, // Alternate colors
                              ),
                            );
                          })
                          .values
          ...
          actions: [
            TextButton(
              ...
              child: Text(
                "Cancel",
                style: TextStyle(
                    color: Colors.redAccent), // Red color for Cancel button
              ),
            ),
            TextButton(
              onPressed: () {
              ...
              child: Text(
                "Add",
                style:
                    TextStyle(color: Colors.teal), // Teal color for Add button
              ),
            ),
          ],
        );
  ...
  void _showEditTodoDialog(BuildContext context, String id, String currentTask,
      String currentDetail) {
    final TextEditingController _editTaskController =
        TextEditingController(text: currentTask);
    final TextEditingController _editDetailController =
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              TextField(
                controller:
                    _editDetailController, // Controller for editing detail
                decoration: InputDecoration(
          ...
          actions: [
            ...
            TextButton(
              ...
              child: Text(
                "Save",
                style:
                    TextStyle(color: Colors.teal), // Teal color for Save button
              ),
            ),
          ],
        );
